...
################################################################################
#####################GUI Configuration Variables below##########################
################################################################################
...
## Okay it's a but obvious I kinda just, jacked the default "qui.rpy" file for this,
## but theres nothing wrong with that, open source, yo.
...
###############################################################################
## Should only be uncommented if its ported to Mobile devices later on. Kept for
## compleations sake, and also because we all know we'd forget it if it wasn't here.
